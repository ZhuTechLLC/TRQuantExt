...
class MainWindow(QMainWindow):
    ...
    def create_sidebar(self) -> QFrame:
        ...
        nav_items = [
            ...
            ("🔥", "投资主线", 2),       # 步骤2: 主线识别、选股（独立模块）
            ("📊", "因子构建", 3),       # 步骤3: 因子库+计算+组合
            ("🛠️", "策略开发", 4),       # 步骤4: 策略生成（整合）
            ("📈", "回测验证", 5),       # 步骤5: 回测
            ("🚀", "实盘交易", 6),       # 步骤6: 实盘
        ]
    ...
    def create_home_page(self) -> QWidget:
        ...
        tools_items = [
            ...
            ("⚙️", "系统设置", "数据源配置与系统管理", Colors.TEXT_MUTED, lambda: self.switch_page(7)),
            ("📋", "运行日志", "查看系统运行记录", Colors.INFO, lambda: self.switch_page(8)),
        ]
